% =========================================================================
% Rain Streaks Removal Approach via Utilizing Discriminatively Intrinsic Priors, Version 2.0
...
% ----------------------------------------------------------------------
%%%      Main model:
%%%      $\min\limits_{\mathcal{B,R,Vi,Di}}\quad\lambda_1||\mathcal{V_1}||_1+\lambda_2||\mathcal{V}_2||_1+\lambda_3||\mathcal{V}_3||_1+\lambda_4||\mathcal{V}_4||_1+\alpha_5||\mathcal{V}_5||_*$
%%%         s.t.
%%%              $\mathcal{V}_1=D_y(\mathcal{R})$
%%%              $\mathcal{V}_2=\mathcal{R}$
%%%              $\mathcal{V}_3=D_x(\mathcal{B})$
%%%              $\mathcal{V}_4=D_t(\mathcal{B})$
%%%              $\mathcal{V}_5=\mathcal{R}$
%%%
...
function [B,R,iter] = rain_removal3_GPU(O,opts)
%%%--- Preparation ---%%%
...
DemonB = mu*ones(Size) + mu*eigsDyTDy + mu*eigsDtTDt;
DemonR = (1+mu)*ones(Size) + mu*eigsDxTDx;
NormO = norm(O(:),'fro');
%%%--- Main loop---%%%
